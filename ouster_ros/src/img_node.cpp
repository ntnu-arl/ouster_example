...
// constexpr size_t bit_depth = sizeof(pixel_type);
...
//         range_image.step = W * sizeof(pixel_type);
//         range_image.encodingsensor_msgs::image_encodings::MONO16;
//         range_image.data.resize(W * H * sizeof(pixel_type));
//         range_image.header.stamp = m->header.stamp;

//         ambient_image.width = W;
//         ambient_image.height = H;
//         ambient_image.step = W * sizeof(pixel_type);
//         ambient_image.encodingsensor_msgs::image_encodings::MONO16;
//         ambient_image.data.resize(W * H * sizeof(pixel_type));
//         ambient_image.header.stamp = m->header.stamp;

//         intensity_image.width = W;
//         intensity_image.height = H;
//         intensity_image.step = W * sizeof(pixel_type);
//         intensity_image.encodingsensor_msgs::image_encodings::MONO16;
//         intensity_image.data.resize(W * H * sizeof(pixel_type));
